...
import bgreg from '../../image/banner/allwebsite.png';
...
const Register = () => {
    ...
    return (
        <>
            <section style={{ background: `url(${bgreg})` }}>
                    ...
                    <div className="row mx-auto">
                        <div className="col-md-6 mx-auto p-3">
                            ...
                            <NavLink className="text-decoration-none" to="/login">
                                <p className="text-center mt-3 text-white fw-bolder"> Already Have Account? Please Login!</p>
                            </NavLink>
